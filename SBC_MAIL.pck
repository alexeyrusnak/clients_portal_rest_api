  ...
  */
  ...
  begin
    ...
    begin
      ...
      rest_api_helper.AddFilter('created_at', 'cl.ord_date', lFilter);
      
      rest_api_helper.AddFilter('date_from', 'lp.source_date_plan', lFilter);
      
      rest_api_helper.AddFilter('date_to', 'dp.source_date_plan', lFilter);
      
      rest_api_helper.AddFilter('status_id', 'ost.orst_id', lFilter);
      
      rest_api_helper.AddFilter('date_closed', 'o.complete_date', lFilter);
      
      rest_api_helper.AddFilter('id', 'o.ord_id', lFilter);
      
      rest_api_helper.AddFilter('shipment_date', 'shipment_date', lFilter); -- ?
      
      rest_api_helper.AddFilter('te_number', 'te_number', lFilter); -- ?
